...
public class UserHandler {
    ...
    public void startLoop() {
        if (auth()) channel.sendStringLine("Программа готова к вводу команд. Введите help для просмотра списка команд");
        else return;
        while (true) {
            channel.sendString(">> ");
            String inputString;
            ...
            List<String> message = new ArrayList<>(Arrays.stream(inputString.split(" ", 2)).toList());
