...
public class LocationBuilder extends Builder<Location> {
    ...
    public LocationBuilder(UserInputChannel inputChannel, UserOutputChannel outputChannel, boolean userMode) {
    ...
    public void setX(){
        ...
        Long value;
        StringValidator<Long> validator = new StringValidator<>(){
            @Override
