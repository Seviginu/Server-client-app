...
public class CoordinatesBuilder extends Builder<Coordinates>{
    ...
    public CoordinatesBuilder(UserInputChannel inputChannel, UserOutputChannel outputChannel, boolean userMode) {
    ...
    public void setX(){
        ...
        Double value;
        StringValidator<Double> validator = new StringValidator<>(){
            @Override
